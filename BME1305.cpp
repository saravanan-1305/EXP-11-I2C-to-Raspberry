...
// BME1305 Registers
#define BME1305_REG_TEMP     0xFA
#define BME1305_REG_PRESS    0xF7
#define BME1305_REG_HUM      0xFD
#define BME1305_REG_CONFIG   0xF5
#define BME1305_REG_CTRL_HUM 0xF2
#define BME1305_REG_CTRL_MEAS 0xF4
...
static void read_compensation_params(i2c_inst_t *i2c) {
    ...
    i2c_write_blocking(i2c, BME1305_ADDR, (uint8_t[]){0x88}, 1, true);
    i2c_read_blocking(i2c, BME1305_ADDR, buf, 26, false);
    ...
    i2c_write_blocking(i2c, BME1305_ADDR, (uint8_t[]){0xE1}, 1, true);
    i2c_read_blocking(i2c, BME1305_ADDR, buf, 7, false);
...
void BME1305_init(i2c_inst_t *i2c) {
    ...
    i2c_write_blocking(i2c, BME1305_ADDR, (uint8_t[]){0xE0, reset_cmd}, 2, false);
    sleep_ms(100);
    ...
    i2c_write_blocking(i2c, BME1305_ADDR, (uint8_t[]){BME1305_REG_CTRL_HUM, 0x01}, 2, false);
    i2c_write_blocking(i2c, BME1305_ADDR, (uint8_t[]){BME1305_REG_CTRL_MEAS, 0x27}, 2, false);
    i2c_write_blocking(i2c, BME1305_ADDR, (uint8_t[]){BME1305_REG_CONFIG, 0x00}, 2, false);
}

BME1305_data BME1305_read(i2c_inst_t *i2c) {
    uint8_t data[8];
    BME1305_data result;

    // Read all data (pressure + temp + hum)
    i2c_write_blocking(i2c, BME1305_ADDR, (uint8_t[]){BME1305_REG_PRESS}, 1, true);
    i2c_read_blocking(i2c, BME1305_ADDR, data, 8, false);
